...
import lynccup_dashboard from "@/public/lynccup-dashboard-demo.png"
import { cn } from "@/lib/utils";

const projects = [
  {
    id: 7,
    title: "Lynccup Dashboard UK",
    description: "A social platform and ticketing solution for both event enthusiasts and organizers",
    longDescription: "Developed the lynccup web dashboard alongside another engineer, for a startup in the UK and integrated with technologies like stripe for payments, google places API and maps. The frontend also integrates with a REST API backend.",
    tags: ["Next JS", "Tailwind CSS", "Framer motion", "Stripe", "Google maps", "Google Places", "Leaflet JS", "Next Auth", "Stripe Webhooks", "Cloudinary"],
    image: lynccup_dashboard,
    public: false,
    links: {
      live: "https://web.lynccup.com",
      github: "#"
    }
  },
  {
