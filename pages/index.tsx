    ...
    return (
        <main>
            <Head>
                ...
                <meta
                    name="description"
                    content="Julius Java's Portfolio Website. Professional Frontend Developer"
                />
            </Head>
            <TransitionEffect />
            <div className="flex items-center justify-between text-dark w-full min-h-screen z-0 bg-light dark:bg-dark p-32 xl:p-24 lg:p-16 md:p-12 sm:p-8 pt-2 lg:flex-col lg:justify-center lg:gap-6">
                ...
                <div className="w-[50%] lg:w-full">
                    ...
                    <AnimatedHeading
                        text={
                            "Crafting Digital Dreams: <br/> Code and Design Fusion."
                        }
                    ...
                    />
                    <p className="font-semibold text-base dark:text-light lg:text-center">
                        {" "}
                        As a skilled front-end web developer, I am dedicated to
                        turning ideas into innovative web applications. Explore
                        my latest projects, showcasing my expertise in React.js,
                        Next JS and web development in general.
                    </p>

                    {/* Home Page CTA */}
                    <div className="mt-6 flex items-center gap-4 lg:justify-center">
                        <Link
                            href={"/juliusjavaresume2024.pdf"}
                            download={true}
                            target="_blank"
              ...
              /> */}
                        ...
                        <Link
                            ...
                            className="text-semibold text-dark underline dark:text-light"
                        >
                            Contact me
                        </Link>
                    </div>
            ...
            <HireMe />
            <div className="absolute right-8 bottom-8 w-28 md:hidden">
                <LightBulbSVG />
            </div>
        </main>
    );
