...
const ExperienceDetails = () => {
    ...
    return (
        <li ref={ref} className='my-8 first:mt-0 last:mb-0 w-[60%] md:w-[80%] mx-auto'>
            ...
            >
                <h3 className='capitalize font-bold text-2xl dark:text-light sm:text-xl xs:text-lg'>Front End Developer <span className='text-primary dark:text-primaryDark'>@ Google</span></h3>
