...
const Skills = () => {
    return (
        <>
            <h2 className="font-bold text-7xl xl:text-6xl lg:text-5xl md:text-4xl sm:text-3xl mt-64 text-center dark:text-light">
                Skills
            </h2>
            <div
            ...
            >
                <div className="text-center rounded-full font-semibold bg-dark text-light px-8 py-4 transition-all duration-100 hover:scale-110 cursor-pointer dark:bg-light dark:text-dark lg:p-6 md:p-4 xs:text-xs xs:p-2">
                    Web
                </div>
                ...
                <Skill name="Next UI" x="35vw" y="-10vw" />
                <Skill name="Firebase" x="-35vw" y="-10vw" />
            </div>
        </>
    );
};
