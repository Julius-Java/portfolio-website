...
const FeaturedProject = ({type, title, summary, img, link, github}: FeaturedProjectProps) => {
    return (
        <article
            className='flex p-12 items-center justify-between rounded-3xl border border-dark bg-light shadow-2xl relative dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'
        >
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                ...
                >
                    <h3 className='my-2 w-full text-left text-4xl font-bold sm:text-sm'>{title}</h3>
                </Link>
